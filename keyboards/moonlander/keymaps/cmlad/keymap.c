...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_NO,            KC_Z,          KC_X,          KC_C,         KC_V,          KC_B,                                                                                                 KC_N,           KC_M,          KC_COMMA_LBRACE,  KC_DOT_RBRACE,   KC_UP,              KC_NO,
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_NO,            KC_PGDOWN,     KC_MAC_CUT,    KC_MAC_COPY,  KC_MAC_PASTE,  KC_NO,                                                                                                KC_NO,          KC_MS_LEFT,     KC_MS_UP,        KC_MS_DOWN,      KC_MS_RIGHT,        KC_NO,
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_NO,            KC_LEFT,       KC_UP,         KC_DOWN,      KC_RIGHT,      KC_NO,                                                                                                KC_MAC_CUT,     LGUI(KC_LEFT),  KC_NO,           LGUI(KC_RIGHT),  KC_PGDOWN,          KC_NO,
